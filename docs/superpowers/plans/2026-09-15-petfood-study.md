    ...
    { "id": "ch01", "no": 1, "title": "ペットフード販売士認定制度の概要", "page": 4,
      "sections": [
        { "id": "ch01-s01", "no": 1, "title": "設立趣旨", "page": 4,
          "blocks": [
            { "type": "p", "sents": [
              "家族の一員であるペットと暮らす際には、ペットの適正な発育と健康維持・増進のために必要な栄養素を、ペットへ毎日与える必要がある。",
              "ペットは家族から食物を与えられなければ、適切な日常の食物摂取ができない生き物である。",
              "そのために考え出され、安心・安全に製造・流通・小売されているのがペットフードである。"
            ]},
            { "type": "list", "sents": [
              "ペットフードの販売や相談に携わる方",
              "将来ペットフードの販売や相談に携わろうと考えている方"
            ]}
          ]},
        { "id": "ch01-s02", "no": 2, "title": "設置", "page": 4,
          "blocks": [
            { "type": "p", "sents": [
              "ペットフード販売士認定委員会を設置し、ペットフードの販売に携わる方に、ペットフード販売士資格を取得できる講習会および試験を実施するものである。"
            ]}
          ]}
      ]}
  ],
...
d['questions'] = [
  {"id":"q0101","sectionId":"ch01-s01","chapterNo":1,"type":"choice4","difficulty":1,
   "question":"ペットフード販売士の資格が対象としている人として、テキストに挙げられていないものはどれか。",
   "choices":["ペットフードの販売や相談に携わる方","将来ペットフードの販売や相談に携わろうと考えている方",
              "将来ペットフード業界の発展に寄与したいと考えている方","ペットを飼育していない一般消費者"],
   "answer":3,
   "explanation":"受験資格は、販売や相談に携わる方、将来携わろうと考えている方、業界の発展に寄与したい方の3つである。",
   "page":4},
  {"id":"q0102","sectionId":"ch01-s02","chapterNo":1,"type":"choice4","difficulty":1,
   "question":"ペットフード販売士資格の講習会および試験を実施する主体はどれか。",
   "choices":["ペットフード販売士認定委員会","農林水産省","環境省","ペットフード公正取引協議会"],
   "answer":0,
   "explanation":"ペットフード販売士認定委員会を設置し、講習会および試験を実施する。",
   "page":4}
]
